...
class MutationTestRunner:
    ...
    def _parse_mutation_results(self, result: subprocess.CompletedProcess, duration: float) -> Dict[str, Any]:
        ...
        if results["total_mutations"] > 0:
            ...
            if effective_total > 0:
                results["mutation_score"] = (results["killed_mutations"] / effective_total) * 100
...
"""
        ...
        if results['mutation_score'] < 60:
            ...
            report += "- GOOD: Mutation score is above 80%. Test suite appears robust.\n"
