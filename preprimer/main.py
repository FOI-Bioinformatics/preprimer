...
def main():
    ...
    convert_parser.add_argument("--output-folder", help="Output folder", required=True)
    convert_parser.add_argument("--prefix", help="File prefix for output files", required=True)
    ...
    align_parser.add_argument("--output-format", choices=['me-pcr', 'exonerate'], nargs='+', help="Output format(s)", required=True)
