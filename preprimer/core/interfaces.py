...
class PrimerData:
    ...
    def artic_name(self) -> str:
        ...
        amplicon_num = self.amplicon_id.split('_')[-1] if '_' in self.amplicon_id else self.amplicon_id
...
class AlignmentProvider(ABC):
    ...
    def align_primers(self,
                     ...
                     output_dir: Union[str, Path]) -> List[PrimerData]:
        """Align primers to reference and return updated primer data."""
        pass
    
    @abstractmethod
    def create_amplicons(self,
