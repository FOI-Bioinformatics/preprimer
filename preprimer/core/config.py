...
class PrePrimerConfig:
    ...
    def validate(self) -> List[str]:
        ...
        if self.aligner not in valid_aligners:
            issues.append(f"Invalid aligner '{self.aligner}'. Must be one of: {valid_aligners}")
        ...
        if self.primer_naming_scheme not in valid_schemes:
            issues.append(f"Invalid naming scheme '{self.primer_naming_scheme}'. Must be one of: {valid_schemes}")
