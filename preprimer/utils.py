...
class AmpliconUpdater:
    ...
    @staticmethod
    def translate_amplicon_info_to_new_reference(amplicon_info, reference_fasta, output_dir, force=False):
        ...
        for amplicon_name, primers in amplicon_info.items():
            ...
            for primer in primers:
                ...
                exonerate_output = Aligner.run_exonerate(primer_name, output_dir, primer_seq, reference_fasta)
                parsed_alignment = Aligner.parse_exonerate_output(exonerate_output)
