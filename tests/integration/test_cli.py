...
class TestCreateParser:
    ...
    def test_parser_convert_subcommand(self, mock_writer_reg, mock_parser_reg):
        ...
        args = parser.parse_args(
            ["convert", "--input", "test.bed", "--output-dir", "output/"]
        )
...
class TestCmdConvert:
    ...
    @patch("preprimer.cli.parser_registry")
    @patch("preprimer.cli.PrimerConverter")
    def test_cmd_convert_validate_only_with_format(
        self, mock_converter_class, mock_registry
    ):
    ...
    @patch("preprimer.cli.parser_registry")
    @patch("preprimer.cli.PrimerConverter")
    def test_cmd_convert_validate_only_auto_detect(
        self, mock_converter_class, mock_registry
    ):
    ...
    @patch("preprimer.cli.parser_registry")
    @patch("preprimer.cli.PrimerConverter")
    def test_cmd_convert_validate_only_unknown_format(
        self, mock_converter_class, mock_registry
    ):
