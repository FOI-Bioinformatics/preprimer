    ...
    def test_converter_all_validation_paths(self):
        ...
        amplicons = [
            ...
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "good_F", "ATCGATCG", 100, 120, "+", "forward", 1, "good_amp"
                    ),
                    PrimerData(
                        "good_R", "CGATCGAT", 300, 320, "-", "reverse", 1, "good_amp"
                    ),
                ],
            ),
            ...
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "empty_F", "", 100, 120, "+", "forward", 1, "empty_seq_amp"
                    ),  # Empty
                    PrimerData(
                        "empty_R", "CGAT", 300, 320, "-", "reverse", 1, "empty_seq_amp"
                    ),
                ],
            ),
            ...
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "long_F", "A" * 100, 100, 120, "+", "forward", 1, "long_amp"
                    ),  # Too long
                    PrimerData(
                        "long_R", "CGAT", 300, 320, "-", "reverse", 1, "long_amp"
                    ),
                ],
            ),
            ...
            AmpliconData(
                ...
                primers=[
                    ...
                    PrimerData(
                        "invalid_R", "CGAT", 300, 320, "-", "reverse", 1, "invalid_amp"
                    ),
                ],
            ),
        ]
