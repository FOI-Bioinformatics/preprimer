...
from preprimer.core.exceptions import (
    PrePrimerError, ParserError, ValidationError, SecurityError,
    InvalidFormatError, CorruptedDataError, InsufficientDataError,
    FileNotFoundError, AlignmentError, OutputError, ConfigError,
    ErrorContext, handle_common_exceptions
)
...
class TestSpecificErrorTypes:
    ...
    def test_output_error_with_path(self):
        ...
        error = OutputError("Write failed", output_path="/tmp/output.txt", format_name="FASTA")
    ...
    def test_config_error_with_file_and_setting(self):
        ...
        error = ConfigError("Invalid setting", config_file="config.yaml", setting="max_primers")
