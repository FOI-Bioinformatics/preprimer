...
from preprimer.core.exceptions import ParserError, OutputError
from preprimer.core.interfaces import PrimerParser, OutputWriter, AlignmentProvider
...
class TestParserRegistryEdgeCases:
    ...
    def test_get_parser_nonexistent_format_error(self):
        ...
        with pytest.raises(ParserError, match="No parser registered for format: nonexistent"):
...
class TestWriterRegistryEdgeCases:
    ...
    def test_get_writer_nonexistent_format_error(self):
        ...
        with pytest.raises(OutputError, match="No writer registered for format: nonexistent"):
...
class TestRegistryEdgeCaseScenarios:
    ...
    def test_detect_format_with_file_validation_exception(self):
        ...
        with patch.object(ExceptionParser, 'validate_file', side_effect=OSError("Test error")):
    ...
    def test_empty_registries_behavior(self):
        ...
        assert empty_parser_registry.detect_format_optimized(Path("/tmp/test.txt")) is None
