...
class TestPrimerschemeInfoValidation:
    ...
    def test_invalid_schemename_characters(self):
        ...
        with pytest.raises(ValueError, match="schemename must be lowercase alphanumeric with hyphens only"):
            PrimerschemeInfo(
    ...
    def test_schemename_starts_with_hyphen(self):
        ...
        with pytest.raises(ValueError, match="schemename cannot start or end with hyphen"):
            PrimerschemeInfo(
...
class TestGenerateInfoJson:
    ...
    def test_generate_info_json_with_all_files(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.bed', delete=False) as primer_file:
