...
class TestRegistryPerformance:
    ...
    def test_registration_performance_improvement(self):
        ...
        assert optimized_time < 0.05, f"Optimized registration took {optimized_time:.3f}s, should be <0.05s"
    ...
    def test_multiple_registrations_performance(self):
        ...
        assert optimized_time < 0.01, f"Multiple registrations took {optimized_time:.3f}s, should be <0.01s"
    ...
    def test_format_detection_memory_efficiency(self):
        ...
        assert instance_count["count"] == 1, f"Created {instance_count['count']} instances, should be 1"
    ...
    def test_registry_metadata_access_performance(self):
        ...
        assert access_time < 0.1, f"Metadata access took {access_time:.3f}s for 1000 iterations, should be <0.1s"
    ...
    def test_concurrent_registry_access(self):
        ...
        for format_name, extensions_list in format_counts.items():
            ...
            for extensions in extensions_list[1:]:
                assert extensions == first_extensions, \
