    ...
    def test_write_missing_primers_warning(self):
        ...
        amplicons = [
            ...
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "amp1_F", "ATCGATCG", 100, 120, "+", "forward", 1, "amp1"
                    )
                ],
                reference_id="chr1",
            ),
            ...
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "amp2_R", "CGATCGAT", 300, 320, "-", "reverse", 1, "amp2"
                    )
                ],
                reference_id="chr1",
            ),
            ...
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "amp3_F", "GCTAGCTA", 500, 520, "+", "forward", 1, "amp3"
                    ),
                    PrimerData(
                        "amp3_R", "TAGCTAG", 700, 720, "-", "reverse", 1, "amp3"
                    ),
                ],
                reference_id="chr1",
            ),
    ...
    def test_write_exception_handling(self):
        ...
        amplicons = [
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "test_F", "ATCGATCG", 100, 120, "+", "forward", 1, "test_amp"
                    ),
                    PrimerData(
                        "test_R", "CGATCGAT", 300, 320, "-", "reverse", 1, "test_amp"
                    ),
                ],
                reference_id="chr1",
            )
        ...
        try:
            ...
            with patch.object(
                writer, "validate_output_path", return_value=Path(temp_path)
            ):
    ...
    def test_write_amplicon_without_reference_id(self):
        ...
        amplicons = [
            AmpliconData(
                ...
                primers=[
                    PrimerData(
                        "simple_F", "AAATTTCCC", 50, 70, "+", "forward", 1, "simple_amp"
                    ),
                    PrimerData(
                        "simple_R",
                        "GGGAAATTT",
...
class TestSTSWriterIntegration:
    ...
    def test_write_realistic_dataset(self):
        ...
        try:
            result = writer.write(
                amplicons, temp_path, reference_path="/ref/covid.fasta"
            )
